...
<div class="query-optimization">
    <div class="tabs flex items-center">
        <button data-tab-value="#tab_connect" class="active uppercase d-flex items-center me-3 text-[13px] pb-2 relative custom-action">
        ...
        <button data-tab-value="#tab_upload" class="uppercase d-flex items-center me-3 text-[13px] pb-2 relative custom-action">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 20 20" stroke-width="1.5" stroke="currentColor" class="me-2">
    ...
    <div class="tab-content bg-no-repeat bg-cover mt-3 p-3 bg-gray-bg">
        <div class="tabs__tab active" id="tab_connect" data-tab-info>
            <form method="POST" id="connect_db" action="{{ route('backend.db_connect.connect-db') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="connection" type="text" class="form-control @error('name') is-invalid @enderror" name="connection" value="{{ old('connection') }}" required autocomplete="connection" autofocus>
                        @error('connection')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="port" type="text" class="form-control @error('port') is-invalid @enderror" name="port" value="{{ old('port') }}" required>
                        @error('port')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="db-name" type="text" class="form-control" name="db_name" value="{{ old('db_name') }}" required>
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="db-username" class="col-md-4 col-form-label text-md-end">{{ __('DB Username') }}</label>

                    <div class="col-md-6">
                        <input id="db-username" type="text" class="form-control" name="db_username" value="{{ old('db_username') }}" required>
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="db-password" class="col-md-4 col-form-label text-md-end">{{ __('DB Password') }}</label>
        ...
        <div class="tabs__tab" id="tab_upload" data-tab-info>
            ...
            <div class="flex items-center justify-center w-full relative">
                <div class="w-100">
                    <textarea placeholder="Entry Query" class="w-100 h-100 rounded-2xl bg-dark-black border-0 p-3 resize-none focus:shadow-none" rows="15"></textarea>
                </div>
                <div class="buttons flex absolute right-7 bottom-5">
                    ...
                    <a href="{{ route('backend.query_logs.caht') }}" class="bg-cyan border-[1px] border-cyan w-12 h-12 rounded-3xl flex items-center justify-center">
